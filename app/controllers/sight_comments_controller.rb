class SightCommentsController < ApplicationController
    ...
    def index
        ...
        respond_with(@sight_comments) do |format|
            format.html { respond_with([@sight, @sight_comments]) }
        end
    end
    ...
    def show
        ...
        respond_with(@sight_comment) do |format|
            format.html { respond_with([@sight, @sight_comment]) }
        end
    end
